...
- [Penyelesaian spesifikasi sisa di peta: Kurva S, Barang Transit, Toleransi, HTTPS, QR, dan Deployment](https://github.com/thcjatim-bit/project-monitoring-system/issues/1) ΓÇö Semua keputusan teknis terkait aturan main SPI, revisi TOC, amandemen RAB, peringatan material transit, serta deployment flow developer dikunci. ADR-0009.

- [Rumus kurva S, SPI, dan indikator kesiapan material](https://github.com/thcjatim-bit/project-monitoring-system/issues/7) — Rumus plan harian vs aktual (berbasis rupiah jasa), indikator material terpisah, SPI dengan threshold (hijau >= 1.0, merah < 0.9). Area lewat TOC memanjang otomatis dengan plan flat 100%. Realisasi > 100% dicegah tanpa Variation Order. ADR-0010.
