...
Glosarium istilah domain. Pakai istilah persis seperti di sini pada nama tabel, kelas, judul issue, teks UI, dan **nama di kawat** — nama field HTML yang dikirim ke server dan atribut `data-*`. Nama di kawat ikut terjerat karena ia yang paling sering dibaca saat menelusuri form: dua arti untuk satu kata dalam satu berkas adalah persis yang aturan ini ada untuk mencegah. Lihat [#134](https://github.com/thcjatim-bit/project-monitoring-system/issues/134).
