        ...
        @auth
            @php
                ...
                $homeUrl = match (true) {
                    ...
                    $canViewMitraDashboard => route('mitra.dashboard'),
                    $canViewPortfolio => route('portfolio.index'),
                ...
                $activeContext = match (true) {
                    ...
                    request()->routeIs('mitra.dashboard') => 'Dashboard Mitra',
            ...
            <div class="app-shell">
                <aside class="app-shell__sidebar" aria-label="Navigasi utama">
                    ...
                    <nav class="app-shell__nav">
                        @if ($canViewDashboard || $canViewMitraDashboard || $canViewPortfolio || $canViewProjects)
                            <div class="app-shell__nav-group">
                                ...
                                @if ($canViewMitraDashboard)
                                    <a @class(['app-shell__nav-link', 'is-active' => request()->routeIs('mitra.dashboard')]) href="{{ route('mitra.dashboard') }}" @if (request()->routeIs('mitra.dashboard')) aria-current="page" @endif>
                                        <span class="app-shell__nav-link-copy"><span class="app-shell__nav-link-mark">MIT</span>Dashboard Mitra</span>
                                    </a>
                                @endif
                                @if ($canViewPortfolio)
                                    <a @class(['app-shell__nav-link', 'is-active' => request()->routeIs('portfolio.*')]) href="{{ route('portfolio.index') }}" @if (request()->routeIs('portfolio.*')) aria-current="page" @endif>
                                        <span class="app-shell__nav-link-copy"><span class="app-shell__nav-link-mark">PF</span>Portfolio</span>
                                    </a>
                                @endif
                                @if ($canViewProjects)
                        ...
                        @if ($canManageApiKeys)
                            <div class="app-shell__nav-group">
                                <span class="app-shell__nav-label">Integrasi</span>
                                <a @class(['app-shell__nav-link', 'is-active' => request()->routeIs('admin.api-keys.*')]) href="{{ route('admin.api-keys.index') }}" @if (request()->routeIs('admin.api-keys.*')) aria-current="page" @endif>
                                    <span class="app-shell__nav-link-copy"><span class="app-shell__nav-link-mark">KEY</span>API Key</span>
                                </a>
                            </div>
                        @endif
                        ...
                        @if ($canViewWarehouse)
                            <div class="app-shell__nav-group">
                                ...
                                @if ($canOperateWarehouse)
                                    <a @class(['app-shell__nav-link', 'is-active' => request()->routeIs('warehouse.index')]) href="{{ route('warehouse.index') }}" @if (request()->routeIs('warehouse.index')) aria-current="page" @endif>
                                        <span class="app-shell__nav-link-copy"><span class="app-shell__nav-link-mark">OPS</span>Operasional Material</span>
                                    </a>
                                @endif
                                @if ($canViewTransfers)
                                    <a @class(['app-shell__nav-link', 'is-active' => request()->routeIs('warehouse.transfers.*')]) href="{{ route('warehouse.transfers.index') }}" @if (request()->routeIs('warehouse.transfers.*')) aria-current="page" @endif>
                                        <span class="app-shell__nav-link-copy"><span class="app-shell__nav-link-mark">SJ</span>Daftar Surat Jalan</span>
                                    </a>
                                @endif
                                @if ($canOperateWarehouse || $canReadTransit)
                                    <a @class(['app-shell__nav-link', 'is-active' => request()->routeIs('warehouse.transit')]) href="{{ route('warehouse.transit') }}" @if (request()->routeIs('warehouse.transit')) aria-current="page" @endif>
                                        <span class="app-shell__nav-link-copy"><span class="app-shell__nav-link-mark">↔</span>Transit</span>
                                    </a>
                                @endif
                            </div>
                        @endif
